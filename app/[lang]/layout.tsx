          ...
          <I18nProvider lang={lang} dict={dict}>
            <CartProvider>
              ...
              <footer className="py-12 px-8 md:px-16 border-t border-olive-dark/10 bg-stone-serene">
                ...
                {/* Enlace al perfil de GitHub del desarrollador junto con imagen de github */}
                <a
                  href="https://github.com/davidvalades"
                  target="_blank"
                  rel="noopener noreferrer"
                  className="flex items-center justify-center gap-2 text-[#706D54] hover:text-[#A08963] transition-colors duration-300"
                >
                  {/* Icono SVG puro de GitHub */}
                  <svg
